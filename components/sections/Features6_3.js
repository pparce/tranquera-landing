...
export default function Features6_3() {
    return (
        <>
            <section id="features-6" className="pb-100 features-section division" style={{paddingTop: 100}}>
                    ...
                    <div className="row justify-content-center">
                        <div className="col-md-10 col-lg-9">
                            <div className="section-title mb-70">
                                ...
                                {/* Text */}
                                <p className="s-21 color--grey">Gestión inteligente para una administración más eficiente.</p>
                            </div>
                        </div>
                    </div>
                    {/* FEATURES-11 WRAPPER */}
                        ...
                        <div className="row row-cols-1 row-cols-md-2 rows-3">
                                ...
                                <div className="fbox-11 fb-1 wow fadeInUp">
                                    ...
                                    <div className="fbox-ico-wrap">
                                        <div className="fbox-ico ico-50">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="72" height="72" color="#0f6bf5" fill="none">
                                    ...
                                    <div className="fbox-txt">
                                        <h6 className="s-22 w-700">Navegación y Optimización de Rutas</h6>
                                        <p>Encuentra el camino más eficiente desde tu ubicación con navegación inteligente y búsqueda avanzada de tranqueras.</p>
                                    </div>
                                </div>
                            ...
                            <div className="col">
                                <div className="fbox-11 fb-2 wow fadeInUp">
                                    ...
                                    <div className="fbox-ico-wrap">
                                        <div className="fbox-ico ico-50">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="72" height="72" color="#0f6bf5" fill="none">
                                                <path d="M15.6181 6.99985C16.2653 7.12386 16.7429 7.34165 17.1213 7.72416C18 8.61245 18 10.0421 18 12.9015V21.9998H6V12.9015C6 10.0421 6 8.61245 6.87868 7.72416C7.25705 7.34165 7.73473 7.12386 8.38188 6.99985" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M18 21.9998H21C21.4714 21.9998 21.7071 21.9998 21.8536 21.8534C22 21.707 22 21.4713 22 20.9998V15.9998C22 14.1142 22 13.1714 21.4142 12.5856C20.8284 11.9998 19.8856 11.9998 18 11.9998" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                                                <path d="M6 21.9998H3C2.5286 21.9998 2.29289 21.9998 2.14645 21.8534C2 21.707 2 21.4713 2 20.9998V15.9998C2 14.1142 2 13.1714 2.58579 12.5856C3.17157 11.9998 4.11438 11.9998 6 11.9998" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                                                ...
                                                <path d="M8.04217 4C10.9662 4 12.0004 2 12.0004 2C12.0004 2 13.0338 4 15.9578 4C16.1752 5.6875 15.6528 9.65 12.0004 11C8.34791 9.65 7.82476 5.6875 8.04217 4Z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round" />
                                            </svg>
                                        </div>
                                    </div>	{/* End Icon */}
                                    {/* Text */}
                                    <div className="fbox-txt">
                                        <h6 className="s-22 w-700">Acceso Rápido a Servicios de Emergencia</h6>
                                        <p>Conéctate inmediatamente con bomberos, policía y servicios de salud mediante el botón de emergencia. Comparte tu ubicación exacta para garantizar una respuesta más eficiente.</p>
                                    </div>
                                </div>
                                    ...
                                    <div className="fbox-ico-wrap">
                                        <div className="fbox-ico ico-50">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="72" height="72" color="#0f6bf5" fill="none">
                                                ...
                                                <path d="M11.9955 12H12.0045M8 12H8.00897" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                            </svg>
                                        </div>
                                    </div>	{/* End Icon */}
                                    {/* Text */}
                                    <div className="fbox-txt">
                                        <h6 className="s-22 w-700">Comunicación Segura entre Vecinos</h6>
                                        <p>Envía y recibe mensajes a través de un chat protegido para facilitar la coordinación y la actualización de información importante en la zona rural.</p>
                                    </div>
                                </div>
                            ...
                            <div className="col">
                                <div className="fbox-11 fb-4 wow fadeInUp">
                                    ...
                                    {/* Text */}
                                    <div className="fbox-txt">
                                        <h6 className="s-22 w-700">Alertas y Notificaciones</h6>
                                        <p>Recibe alertas sobre tráfico, condiciones climáticas y emergencias.</p>
                                    </div>
                                </div>
